...
- **[Enterprise AI Observability](https://alexkalyvas.substack.com/p/trends-challenges-and-opportunities)** *(Stanford GSB · IR 390 · Dec 2025)*. Primary research, 100+ AI engineers and founders. Headline: 60% of AI-natives already run agents in production; next bottlenecks are **privacy/security, observability, and continual learning**, not hallucinations. Three-part Substack series.
- **[Enterprise AI Time-to-Value](https://alexkalyvas.substack.com/p/how-long-does-enterprise-ai-take)** *(Stanford GSB · IR 390 · Mar 2026)*. Only **14% of practitioners reach measurable impact in under a month**, yet 50% expect that to be standard by 2027 (a 4× expectation gap). Argues implementation quality, not model quality, is the next moat.
- **[Rosetta Sycophant](https://rosettasyncophant.streamlit.app)** *(Stanford GSB · AI and Power · Winter 2026)*. Live tool detecting identity-based bias in AI translation. Same source text, two user profiles → "invasion" vs "intrusion." With Barry Thrasher and Humzah Khan.
